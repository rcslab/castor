...
#define RREVENT_TABLE\
    ...
    RREVENT(BARRIER_INIT,   0x00010012)\
    RREVENT(BARRIER_DESTROY,0x00010013)\
    RREVENT(BARRIER_WAIT,   0x00010014)\
    RREVENT(SPIN_INIT,      0x00010015)\
    RREVENT(SPIN_DESTROY,   0x00010016)\
    RREVENT(SPIN_TRYLOCK,   0x00010017)\
    RREVENT(SPIN_LOCK,      0x00010018)\
    RREVENT(SPIN_UNLOCK,    0x00010019)\
    RREVENT(RWLOCK_INIT,      0x0001001A)\
    RREVENT(RWLOCK_DESTROY,   0x0001001B)\
    RREVENT(RWLOCK_UNLOCK,    0x0001001C)\
    RREVENT(RWLOCK_RDLOCK,    0x0001001D)\
    RREVENT(RWLOCK_TRYRDLOCK, 0x0001001E)\
    RREVENT(RWLOCK_WRLOCK,    0x0001001F)\
    RREVENT(RWLOCK_TRYWRLOCK, 0x00010020)\
    ...
    RREVENT(FCHDIR,		0x0002001B)\
    RREVENT(FSTATFS,		0x0002001C)\
    RREVENT(GETDIRENTRIES,	0x0002001D)\
    RREVENT(GETDENTS,		0x0002001E)\
    RREVENT(STAT,		0x0002001F)\
    RREVENT(PREAD,		0x00020020)\
    RREVENT(STATFS,		0x00020021)\
    RREVENT(EACCESS,		0x00020022)\
    RREVENT(FDACCESSAT,		0x00020023)\
    ...
    RREVENT(FACCESSAT,          0x00020031)\
    RREVENT(READLINK,           0x00020032)\
    RREVENT(READLINKAT,         0x00020033)\
    RREVENT(UNLINKAT,		0x00020034)\
    RREVENT(LINKAT,		0x00020035)\
    RREVENT(FCHMOD,		0x00020036)\
    RREVENT(LCHMOD,		0x00020037)\
    RREVENT(FCHMODAT,		0x00020038)\
    ...
    RREVENT(SEM_POST_START,	0x00090085)\
    RREVENT(SEM_POST_END,	0x00090086)\
    RREVENT(SEM_WAIT,		0x00090087)\
    RREVENT(SEM_TRYWAIT,	0x00090088)\
    RREVENT(SEM_TIMEDWAIT,	0x00090089)\
    RREVENT(SEM_GETVALUE,	0x0009008A)\
    RREVENT(SEM_INIT,		0x0009008B)\
    RREVENT(SEM_DESTROY,	0x0009008C)
