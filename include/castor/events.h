...
#define RREVENT_TABLE_MANUAL\
    ...
    RREVENT(RWLOCK_TIMEDRDLOCK, 0x00010021)\
    RREVENT(RWLOCK_TIMEDWRLOCK, 0x00010022)\
    RREVENT(MUTEX_TIMEDLOCK,0x00010023)\
    RREVENT(THREAD_EXIT,   0x00010024)\
    RREVENT(THREAD_DETACH, 0x00010025)\
    RREVENT(THREAD_JOIN,   0x00010026)\
    RREVENT(THREAD_KILL,   0x00010027)\
    RREVENT(THREAD_TIMEDJOIN,   0x00010028)\
    ...
    RREVENT(PREADV,             0x00020029)\
    RREVENT(WRITEV,             0x0002002A)\
...
#define RREVENT_TABLE RREVENT_TABLE_MANUAL RREVENT_TABLE_GEN
